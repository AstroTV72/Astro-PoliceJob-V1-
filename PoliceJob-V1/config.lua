...
Config.pos = {
	...
	garagevoiture = {
        position = {x = 458.89, y = -1017.26, z = 28.17, h = 92.82}
    },
	garageheli = {
...
police = {
	...
	vehicles = {                                                         -- category = Separator en rageui 
        car = {                                                           -- Label = nom ig qui apparaitra sur le bouton 
            ...
            {model = "police6", label = "4x4 K-9 Police departement", minimum_grade = 0, stock = 10}, --minimum_grade = grade minmum pour prendre
			{model = "police2", label = "Dodge Charger", minimum_grade = 1, stock = 10},
            {model = "police3", label = "4x4 Cruiser", minimum_grade = 2, stock = 10},
            {model = "ghispo2", label = "Maserati - VIR", minimum_grade = 2, stock = 5},
            {model = "pol718", label = "Porsche - VIR", minimum_grade = 3, stock = 5},
			{model = "Lp770cop", label = "Lamborghini Aventador", minimum_grade = 4, stock = 5},
			{model = "pol458", label = "Ferrari 458", minimum_grade = 4, stock = 5},
			{model = "polamggtr", label = "Mercedes-AMG GTR", minimum_grade = 4, stock = 5},
			{model = "polchiron", label = "Bugatti Chiron", minimum_grade = 4, stock = 5},
			{model = "polp1", label = "Polestar 1 (2022)", minimum_grade = 4, stock = 5},
